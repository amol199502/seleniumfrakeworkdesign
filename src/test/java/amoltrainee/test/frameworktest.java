...
public class frameworktest {
	...
	public static void main(String[] args) {
		...
		WebDriverManager.chromedriver().setup();
		 ...
		 driver.findElement(By.id("userEmail")).sendKeys("chaudhariamol173@gmail.com");
		 driver.findElement(By.id("userPassword")).sendKeys("Chaudhari@199502");
        ...
        wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.cssSelector("#toast-container")));
         ...
         boolean match =carproducts.stream().anyMatch(cp->cp.getText().equalsIgnoreCase(productname));
          ...
          String cartconfrimsg =driver.findElement(By.cssSelector(".hero-primary")).getText();
          
          Assert.assertTrue(cartconfrimsg.equalsIgnoreCase(" Thankyou for the order."));
